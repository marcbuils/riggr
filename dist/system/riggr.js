System.register(['knockout', 'jquery', 'observer', 'router'], function (_export) {
  var ko, $, observer, router, App, count, loaded, appTitle, transition, controllers, paths, appContainer, viewContainer, beforeRoute, setTitle, applyLibs, loadView, registerObservables, build, loadApp;

  // Loops through and loads routes, sets app properties

  _export('default', rigg);
  ...
  return {
    ...
    execute: function () {
      ...
      applyLibs = function (controller, cb) {
        var totalLibs;
        var libsLoaded = 0;
      ...
      loadView = function (view, controller, args, load) {
      ...
      registerObservables = function (vm) {
